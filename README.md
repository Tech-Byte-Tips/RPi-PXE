...
For now, I don't consider updating the CLI often.  Effort will be primarily placed on the main branch.
```

* The **main** branch will be a fresh start for the project, given some ideas and ambitions that I have for it.

  This will be a full-fledged, python-based, web application.

* The **cli** branch will contain the code for the CLI version of this application (how I started).

  More details for those will be provided in README files there.
